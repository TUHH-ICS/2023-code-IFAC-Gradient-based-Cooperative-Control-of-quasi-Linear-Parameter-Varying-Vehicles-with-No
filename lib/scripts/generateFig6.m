...
for  Kd_i = gridKd
    ...
    Kd = Kd_i;      %Kd gain of the Gpq system
    ...
    for delta_i = gridDelta
        ...
        constants.Kd = Kd_i;                    %Grid point of Kd_i
        ...
        barMsg = ['Almost there... ' num2str(barProgress*100) '%'  '  [d Kd] = ' num2str([delta_i Kd_i])];
